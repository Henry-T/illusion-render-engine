...
// 缩略图的支持
void CEffectEditorDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CEffectEditorDoc::InitializeSearchContent()
{
...
void CEffectEditorDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
